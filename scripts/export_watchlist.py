...
def main() -> int:
    ...
    payload = {
        ...
        "stats": {
            ...
            "imdb_unique_titles": int(stats.get("imdb_unique_titles", 0)),
            "imdb_dropped_movies_only_tv": int(stats.get("imdb_dropped_movies_only_tv", 0)),
            "imdb_stripped_tv_from_both": int(stats.get("imdb_stripped_tv_from_both", 0)),
            "imdb_dropped_movies_only_unknown_type": int(stats.get("imdb_dropped_movies_only_unknown_type", 0)),
            "imdb_stripped_unknown_type_from_both": int(stats.get("imdb_stripped_unknown_type_from_both", 0)),
            "imdb_title_type_missing_omdb": int(stats.get("imdb_title_type_missing_omdb", 0)),
